    ...
    <p>
        <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="978px" AllowPaging="True" AutoGenerateRows="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="MaSP" DataSourceID="SqlDataSource2" ForeColor="Black" GridLines="Vertical">
            ...
            <Fields>
                ...
                <asp:BoundField DataField="Hinh_Anh" HeaderText="Images" SortExpression="Hinh_Anh" />
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Data Source=(LocalDB)\v11.0;AttachDbFilename=|DataDirectory|\BANHANG.mdf;Integrated Security=True" DeleteCommand="DELETE FROM [San_Pham] WHERE [MaSP] = @MaSP" InsertCommand="INSERT INTO [San_Pham] ([MaSP], [Ma_DanhMuc_Cha], [Don_Vi], [TenSP], [GiaSP], [Chu_Thich], [Hinh_Anh]) VALUES (@MaSP, @Ma_DanhMuc_Cha, @Don_Vi, @TenSP, @GiaSP, @Chu_Thich, @Hinh_Anh)" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [MaSP], [Ma_DanhMuc_Cha], [Don_Vi], [TenSP], [GiaSP], [Chu_Thich], [Hinh_Anh] FROM [San_Pham]" UpdateCommand="UPDATE [San_Pham] SET [Ma_DanhMuc_Cha] = @Ma_DanhMuc_Cha, [Don_Vi] = @Don_Vi, [TenSP] = @TenSP, [GiaSP] = @GiaSP, [Chu_Thich] = @Chu_Thich, [Hinh_Anh] = @Hinh_Anh WHERE [MaSP] = @MaSP">
            <DeleteParameters>
